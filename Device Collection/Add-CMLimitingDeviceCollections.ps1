...
.EXAMPLE
    .\Add-CMLimitingDeviceCollections.ps1 -SiteServer CM01 -FolderName "Limiting Collections"

.NOTES
    FileName:    Add-CMLimitingDeviceCollections.ps1
...
# Table of collections
    $CollectionTable = @{
        ...
        "LC - All Windows Servers" = "select SMS_R_System.ResourceId, SMS_R_System.ResourceType, SMS_R_System.Name, SMS_R_System.SMSUniqueIdentifier, SMS_R_System.ResourceDomainORWorkgroup, SMS_R_System.Client from  SMS_R_System where SMS_R_System.OperatingSystemNameandVersion like '%Server 6.%' or SMS_R_System.OperatingSystemNameandVersion like '%Server 10%'"
